...
PATH_RASTER = "/home/hlinares/paris/ISS-processing/rasters"
# PATH to directory containing XYZ.csv files
PATH_XYZ = "/home/hlinares/paris/ISS-processing/csvs"
# PATH to directory where np arrays will be write
PATH_ARRAYS = "/home/hlinares/paris/ISS-processing/sources"
...
for idx, img in enumerate(os.listdir(PATH_RASTER)):
    ...
    val[val == 0.0] = np.nan  # convert 0 to nan
    ...
    params.update(
        {img.split("_")[0]: (np.around(lat, 5), np.around(lon, 5), val)}
    )
print(params)
